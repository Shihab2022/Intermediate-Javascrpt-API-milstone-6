...
/* const myObject = {
        ...
        id: '2010628126',
        profession: 'student',
        friend: [' ekon', 'noyon', 'kafi', 'samad', 'mahidul'],
        totalExam: function() {
            const newName = this.name + this.friend
            return newName
        }
    }
    // const bew = myObject.totalExam()
const newFunction = (bew) => {
    console.log('my new function', bew)
}
newFunction(myObject.totalExam())
console.log(myObject.profession)
console.log(myObject.friend)
    // console.log(myObject.totalExam())
 */
